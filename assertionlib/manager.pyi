...
class AssertionManager(AbstractDataClass, metaclass=_MetaAM):
    ...
    @overload
    def issuperset(self, __a: Iterable[Hashable], __b: Iterable[Hashable], *, invert: bool = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def issuperset(self, __a: Iterable[Hashable], __b: Iterable[Hashable], *, exception: None, invert: bool = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def issuperset(self, *args: Any, exception: Type[AssertionError], invert: bool = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> NoReturn: ...
    @overload
    def issuperset(self, *args: Any, exception: Type[Exception], invert: bool = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> None: ...

    @overload
    def issubset(self, __a: Iterable[Hashable], __b: Iterable[Hashable], *, invert: bool = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def issubset(self, __a: Iterable[Hashable], __b: Iterable[Hashable], *, exception: None, invert: bool = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def issubset(self, *args: Any, exception: Type[AssertionError], invert: bool = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> NoReturn: ...
    @overload
    def issubset(self, *args: Any, exception: Type[Exception], invert: bool = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> None: ...
