...
class AssertionManager(AbstractDataClass, metaclass=_MetaAM):
    ...
    @overload
    def abs(self, __a: SupportsAbs[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def abs(self, __a: SupportsAbs[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def add(self, __a: _SupportsAdd[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def add(self, __a: _SupportsAdd[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def and_(self, __a: _SupportsAnd[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def and_(self, __a: _SupportsAnd[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def concat(self, __a: ST, __b: Sequence[Any], *, invert: bool_ = ..., post_process: Optional[Callable[[ST], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def concat(self, __a: ST, __b: Sequence[Any], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[ST], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def eq(self, __a: Optional[_SupportsEq[T, RT]], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def eq(self, __a: Optional[_SupportsEq[T, RT]], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def floordiv(self, __a: _SupportsFloordiv[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def floordiv(self, __a: _SupportsFloordiv[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def ge(self, __a: Union[_SupportsGe[T, RT], _SupportsLe[T, RT]], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ge(self, __a: Union[_SupportsGe[T, RT], _SupportsLe[T, RT]], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def getitem(self, __a: _SupportsGetitem[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def getitem(self, __a: _SupportsGetitem[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def gt(self, __a: _SupportsGt[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def gt(self, __a: _SupportsGt[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def indexOf(self, __a: Iterable[Any], __b: Any, *, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def indexOf(self, __a: Iterable[Any], __b: Any, *, exception: None, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def inv(self, __a: _SupportsInvert[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def inv(self, __a: _SupportsInvert[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def invert(self, __a: _SupportsInvert[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def invert(self, __a: _SupportsInvert[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def le(self, __a: _SupportsLe[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def le(self, __a: _SupportsLe[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def lshift(self, __a: _SupportsLshift[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def lshift(self, __a: _SupportsLshift[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def lt(self, __a: _SupportsLt[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def lt(self, __a: _SupportsLt[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def matmul(self, __a: _SupportsMatmul[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def matmul(self, __a: _SupportsMatmul[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def mod(self, __a: _SupportsMod[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def mod(self, __a: _SupportsMod[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def mul(self, __a: _SupportsMul[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def mul(self, __a: _SupportsMul[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def ne(self, __a: Optional[_SupportsNe[T, RT]], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ne(self, __a: Optional[_SupportsNe[T, RT]], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def neg(self, __a: _SupportsNeg[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def neg(self, __a: _SupportsNeg[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def not_(self, __a: Optional[_SupportsBool], *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def not_(self, __a: Optional[_SupportsBool], *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def or_(self, __a: _SupportsOr[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def or_(self, __a: _SupportsOr[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def pos(self, __a: _SupportsPos[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def pos(self, __a: _SupportsPos[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def pow(self, __a: _SupportsPow[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def pow(self, __a: _SupportsPow[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def rshift(self, __a: _SupportsRshift[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def rshift(self, __a: _SupportsRshift[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def sub(self, __a: _SupportsSub[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def sub(self, __a: _SupportsSub[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def truediv(self, __a: _SupportsTruediv[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def truediv(self, __a: _SupportsTruediv[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def truth(self, __a: Optional[_SupportsBool], *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def truth(self, __a: Optional[_SupportsBool], *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def xor(self, __a: _SupportsXor[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def xor(self, __a: _SupportsXor[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def length_hint(self, __obj: Union[Sized, _SupportsLengthHint], *, default: int = ..., invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def length_hint(self, __obj: Union[Sized, _SupportsLengthHint], *, exception: None, default: int = ..., invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def isdisjoint(self, __a: Set[Any], __b: Iterable[Any], *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def isdisjoint(self, __a: Set[Any], __b: Iterable[Any], *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def shape_eq(self, __a: _SupportsShape, __b: Union[_SupportsShape, Tuple[SupportsInt, ...]], *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def shape_eq(self, __a: _SupportsShape, __b: Union[_SupportsShape, Tuple[SupportsInt, ...]], *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
