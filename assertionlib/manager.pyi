...
if sys.version_info >= (3, 8):
    ...
    from typing_extensions import Final, final, Literal
...
PostProcessInt = Optional[Callable[[int], Optional[_SupportsBool]]]
PostProcessBool = Optional[Callable[[bool], Optional[_SupportsBool]]]
...
class AssertionManager(AbstractDataClass, metaclass=_MetaAM):
    ...
    @overload
    def assert_(self, __func: Callable[..., RT], *args: Any, exception: Type[AssertionError], invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ..., **kwargs: Any) -> NoReturn: ...
    @overload
    def assert_(self, __func: Callable[..., RT], *args: Any, exception: Optional[Type[Exception]] = ..., invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ..., **kwargs: Any) -> None: ...

    def __call__(self, value: RT, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    ...
    @overload
    def abs(self, a: SupportsAbs[RT], invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def abs(self, a: SupportsAbs[RT], exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def add(self, a: _SupportsAdd[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def add(self, a: _SupportsAdd[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def and_(self, a: _SupportsAnd[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def and_(self, a: _SupportsAnd[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def concat(self, a: ST, b: Sequence[Any], invert: bool_ = ..., post_process: Optional[Callable[[ST], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def concat(self, a: ST, b: Sequence[Any], exception: None, invert: bool_ = ..., post_process: Optional[Callable[[ST], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def contains(self, a: Container[Any], b: Any, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def contains(self, a: Container[Any], b: Any, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def countOf(self, a: Iterable[Any], b: Any, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def countOf(self, a: Iterable[Any], b: Any, exception: None, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def eq(self, a: Optional[_SupportsEq[T, RT]], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def eq(self, a: Optional[_SupportsEq[T, RT]], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def floordiv(self, a: _SupportsFloordiv[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def floordiv(self, a: _SupportsFloordiv[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def ge(self, a: Union[_SupportsGe[T, RT], _SupportsLe[T, RT]], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ge(self, a: Union[_SupportsGe[T, RT], _SupportsLe[T, RT]], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def getitem(self, a: _SupportsGetitem[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def getitem(self, a: _SupportsGetitem[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def gt(self, a: _SupportsGt[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def gt(self, a: _SupportsGt[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def index(self, a: _SupportsIndex, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def index(self, a: _SupportsIndex, exception: None, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def indexOf(self, a: Iterable[Any], b: Any, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def indexOf(self, a: Iterable[Any], b: Any, exception: None, invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def inv(self, a: _SupportsInvert[RT], invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def inv(self, a: _SupportsInvert[RT], exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def invert(self, a: _SupportsInvert[RT], invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def invert(self, a: _SupportsInvert[RT], exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def is_(self, a: Any, b: Any, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def is_(self, a: Any, b: Any, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def is_not(self, a: Any, b: Any, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def is_not(self, a: Any, b: Any, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def le(self, a: _SupportsLe[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def le(self, a: _SupportsLe[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def lshift(self, a: _SupportsLshift[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def lshift(self, a: _SupportsLshift[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def lt(self, a: _SupportsLt[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def lt(self, a: _SupportsLt[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def matmul(self, a: _SupportsMatmul[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def matmul(self, a: _SupportsMatmul[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def mod(self, a: _SupportsMod[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def mod(self, a: _SupportsMod[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def mul(self, a: _SupportsMul[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def mul(self, a: _SupportsMul[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def ne(self, a: Optional[_SupportsNe[T, RT]], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ne(self, a: Optional[_SupportsNe[T, RT]], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def neg(self, a: _SupportsNeg[RT], invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def neg(self, a: _SupportsNeg[RT], exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def not_(self, a: Optional[_SupportsBool], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def not_(self, a: Optional[_SupportsBool], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def or_(self, a: _SupportsOr[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def or_(self, a: _SupportsOr[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def pos(self, a: _SupportsPos[RT], invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def pos(self, a: _SupportsPos[RT], exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def pow(self, a: _SupportsPow[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def pow(self, a: _SupportsPow[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def rshift(self, a: _SupportsRshift[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def rshift(self, a: _SupportsRshift[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def sub(self, a: _SupportsSub[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def sub(self, a: _SupportsSub[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def truediv(self, a: _SupportsTruediv[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def truediv(self, a: _SupportsTruediv[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def truth(self, a: Optional[_SupportsBool], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def truth(self, a: Optional[_SupportsBool], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def xor(self, a: _SupportsXor[T, RT], b: T, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def xor(self, a: _SupportsXor[T, RT], b: T, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], Optional[_SupportsBool]]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def length_hint(self, obj: Union[Sized, _SupportsLengthHint], default: int = ..., invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def length_hint(self, obj: Union[Sized, _SupportsLengthHint], exception: None, default: int = ..., invert: bool_ = ..., post_process: PostProcessInt = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def length_hint(self, *args: Any, exception: Type[AssertionError], invert: bool_ = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> NoReturn: ...
    @overload
    def length_hint(self, *args: Any, exception: Type[Exception], invert: bool_ = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> None: ...
    ...
    @overload
    def bool(self, __o: Optional[_SupportsBool], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def bool(self, __o: Optional[_SupportsBool], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def hasattr(self, __obj: Any, __name: str, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def hasattr(self, __obj: Any, __name: str, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def any(self, __obj: Iterable[Optional[_SupportsBool]], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def any(self, __obj: Iterable[Optional[_SupportsBool]], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def all(self, __obj: Iterable[Optional[_SupportsBool]], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def all(self, __obj: Iterable[Optional[_SupportsBool]], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def isdisjoint(self, a: AbstractSet[Any], b: Iterable[Any], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def isdisjoint(self, a: AbstractSet[Any], b: Iterable[Any], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def isdisjoint(self, *args: Any, exception: Type[AssertionError], invert: bool_ = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> NoReturn: ...
    @overload
    def isdisjoint(self, *args: Any, exception: Type[Exception], invert: bool_ = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> None: ...

    # os

    @overload
    def isabs(self, s: Union[str, bytes, os.PathLike], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def isabs(self, s: Union[str, bytes, os.PathLike], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def islink(self, path: Union[str, bytes, os.PathLike], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def islink(self, path: Union[str, bytes, os.PathLike], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def ismount(self, path: Union[str, bytes, os.PathLike], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ismount(self, path: Union[str, bytes, os.PathLike], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def isdir(self, s: Union[str, bytes, os.PathLike], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def isdir(self, s: Union[str, bytes, os.PathLike], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def isfile(self, path: Union[str, bytes, os.PathLike], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def isfile(self, path: Union[str, bytes, os.PathLike], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def shape_eq(self, a: _SupportsShape, b: Union[_SupportsShape, Tuple[SupportsInt, ...]], invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def shape_eq(self, a: _SupportsShape, b: Union[_SupportsShape, Tuple[SupportsInt, ...]], exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def len_eq(self, a: Sized, b: SupportsInt, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def len_eq(self, a: Sized, b: SupportsInt, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def str_eq(self, a: T, b: str, str_converter: Callable[[T, RT], str] = ..., invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def str_eq(self, a: T, b: str, str_converter: Callable[[T, RT], str] = ..., exception: None = ..., invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def function_eq(self, func1: _SupportsCode, func2: _SupportsCode, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def function_eq(self, func1: _SupportsCode, func2: _SupportsCode, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
