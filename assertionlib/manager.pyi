...
PostProcessAny = Optional[Callable[[Any], _SupportsBool]]
...
class AssertionManager(AbstractDataClass, metaclass=_MetaAM):
    ...
    @overload
    def assert_(self, __func: Callable[..., RT], *args: Any, exception: Type[AssertionError], invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ..., **kwargs: Any) -> NoReturn: ...
    @overload
    def assert_(self, __func: Callable[..., RT], *args: Any, exception: Optional[Type[Exception]] = ..., invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ..., **kwargs: Any) -> None: ...

    def __call__(self, value: RT, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    ...
    @overload
    def abs(self, __a: SupportsAbs[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def abs(self, __a: SupportsAbs[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def add(self, __a: _SupportsAdd[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def add(self, __a: _SupportsAdd[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def and_(self, __a: _SupportsAnd[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def and_(self, __a: _SupportsAnd[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def concat(self, __a: ST, __b: Sequence[Any], *, invert: bool_ = ..., post_process: Optional[Callable[[ST], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def concat(self, __a: ST, __b: Sequence[Any], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[ST], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def eq(self, __a: _SupportsEq[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def eq(self, __a: None, __b: Any, *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def eq(self, __a: _SupportsEq[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def floordiv(self, __a: _SupportsFloordiv[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def floordiv(self, __a: _SupportsFloordiv[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def ge(self, __a: Union[_SupportsGe[T, RT], _SupportsLe[T, RT]], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ge(self, __a: Union[_SupportsGe[T, RT], _SupportsLe[T, RT]], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def getitem(self, __a: _SupportsGetitem[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def getitem(self, __a: _SupportsGetitem[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def gt(self, __a: _SupportsGt[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def gt(self, __a: _SupportsGt[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def inv(self, __a: _SupportsInvert[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def inv(self, __a: _SupportsInvert[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def invert(self, __a: _SupportsInvert[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def invert(self, __a: _SupportsInvert[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def le(self, __a: _SupportsLe[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def le(self, __a: _SupportsLe[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def lshift(self, __a: _SupportsLshift[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def lshift(self, __a: _SupportsLshift[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def lt(self, __a: _SupportsLt[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def lt(self, __a: _SupportsLt[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def matmul(self, __a: _SupportsMatmul[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def matmul(self, __a: _SupportsMatmul[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def mod(self, __a: _SupportsMod[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def mod(self, __a: _SupportsMod[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def mul(self, __a: _SupportsMul[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def mul(self, __a: _SupportsMul[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def ne(self, __a: _SupportsNe[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ne(self, __a: None, __b: Any, *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def ne(self, __a: _SupportsNe[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def neg(self, __a: _SupportsNeg[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def neg(self, __a: _SupportsNeg[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def not_(self, __a: _SupportsBool, *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def not_(self, __a: _SupportsBool, *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def or_(self, __a: _SupportsOr[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def or_(self, __a: _SupportsOr[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def pos(self, __a: _SupportsPos[RT], *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def pos(self, __a: _SupportsPos[RT], *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def pow(self, __a: _SupportsPow[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def pow(self, __a: _SupportsPow[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def rshift(self, __a: _SupportsRshift[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def rshift(self, __a: _SupportsRshift[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def sub(self, __a: _SupportsSub[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def sub(self, __a: _SupportsSub[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def truediv(self, __a: _SupportsTruediv[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def truediv(self, __a: _SupportsTruediv[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def truth(self, __a: _SupportsBool, *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def truth(self, __a: _SupportsBool, *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def xor(self, __a: _SupportsXor[T, RT], __b: T, *, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def xor(self, __a: _SupportsXor[T, RT], __b: T, *, exception: None, invert: bool_ = ..., post_process: Optional[Callable[[RT], _SupportsBool]] = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def bool(self, __o: _SupportsBool, *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def bool(self, __o: _SupportsBool, *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def any(self, __obj: Iterable[_SupportsBool], *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def any(self, __obj: Iterable[_SupportsBool], *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    ...
    @overload
    def all(self, __obj: Iterable[_SupportsBool], *, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
    def all(self, __obj: Iterable[_SupportsBool], *, exception: None, invert: bool_ = ..., post_process: PostProcessBool = ..., message: Optional[str] = ...) -> None: ...
    @overload
