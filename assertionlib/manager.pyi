...
class AssertionManager(AbstractDataClass, metaclass=_MetaAM):
    ...
    @overload
    def assert_(self, __func: Callable[..., RT], *args: Any, exception: None = ..., invert: bool = ..., post_process: Optional[Callable[[RT], object]] = ..., message: Optional[str] = ..., **kwargs: Any) -> NoReturn: ...
    @overload
    def assert_(self, __func: Callable[..., Any], *args: Any, exception: Type[Exception], invert: bool = ..., post_process: PostProcessAny = ..., message: Optional[str] = ..., **kwargs: Any) -> None: ...
